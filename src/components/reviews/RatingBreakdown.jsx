  ...
  return (
    ...
    <p id="ratingBreakdown-title">RATINGS & REVIEWS</p>
      ...
      <div id="rating-summary">
        ...
        <div className="percentRec">{`${calculatePercentRecommend(props.metadata.recommended)}%`} of {`${calculateTotalRatings(props.metadata.ratings)}`} total reviewers recommend this product</div>
