...
export default function ProductInfo(props) {
  ...
  return (
    <div  className="w-full flex-row p-10 h-full hidden md:flex">
        <div id="overview_description" className="w-4/6 flex flex-col items-center pl-4 pr-10">
            <h1 id="overview_slogan_text" className="text-3xl">{slogan}</h1>
            <p id="overview_description_text" >{description}</p>
        </div>
        ...
        <div id="overview_feature" className="w-2/6 flex flex-col items-center justify-center" >
            <div className="flex flex-col items-start">
                ...
                <div className="flex" key={i}>
                    {check}
                    <p id="overview_feature_text">{feature} : {value}</p>
                </div>
                )})}
            </div>
        </div>
