  ...
  return (
    <div className={`p-3  border-b-2 ${cartVisibility ? "" : "hidden"}`}>
        <div className="flex items-center justify-around">
            <div className="p-2">
                <input className="text-center text-xl w-40 " type="number" name={order.style_id} min="1" max={order.maxQuantity} value={order.quantity} onChange={(e) => handleModifyOrder(Number(e.target.value), order)}/>   
            </div>
            <div>
