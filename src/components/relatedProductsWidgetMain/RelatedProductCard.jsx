    ...
    return (
      <div name={props.prop1.product_id} className='relatedProductCards'>
        <svg onClick={(event) => {
          ...
          props.prop2(event)
        }} xmlns="http://www.w3.org/2000/svg" name={props.prop1.product_id} className="h-5 w-5 comparison_but" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div onClick={props.addCard} name={props.prop1.product_id}>
          ...
          <div className="relatedProduct-description">
